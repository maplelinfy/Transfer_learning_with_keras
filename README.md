...
In your data path, each category is a folder containing all of its samples(refer to data_path_example.jpg), a folder named 'split_data' is generated by default, which has 'train', 'valid', 'test' in it. 
